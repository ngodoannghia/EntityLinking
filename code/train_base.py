...
if __name__=='__main__':
    ...
    train_samples = samples[:200000]
    valid_samples = samples[200000:250000]
    ...
    # if os.path.exists('../data/model_el_base_200k.pt'):
    #     model.load_state_dict(torch.load('../data/model_el_base_200k.pt'))
    ...
    for e in range(epoch):
        ...
        if acc_valid > best:
            best = acc_valid
            torch.save(model.state_dict(), '../data/model_el_base_200k.pt')
