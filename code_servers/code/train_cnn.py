...
if __name__ =='__main__':
    ...
    ## argument encoder
    d_model, n_layers, n_heads, d_ff, pad_idx = 256, 8, 8, 512, 0
    output_encoder = 128
    ...
    ## argument mlp score
    input_dim_mlp_score, output_dim_mlp_score, num_hidden_mlp_score1, num_hidden_mlp_score2, num_hidden_mlp_score3, num_hidden_mlp_score4 = output_encoder * 2 +  output_dim_cnn * 2 + output_dim_mlp_embed + 1, 1, 1024, 512, 128, 10


    random.seed(100)
    random.shuffle(samples)
    train_samples = samples[:100000]
    valid_samples = samples[100000:150000]
    ...
    best = -1000
    path_save_model = '../data/cnn_model_10k.pt'
